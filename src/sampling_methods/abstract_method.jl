...
"""
Sample from the distribution given by the pdf `π` using the given `ProposalDistribution` and `DistributionFitter`.
...
"""
function (::SamplingMethod)(π, ::ProposalDistribution, ::DistributionFitter;
